"""
fetch_abs.py
Downloads key Australian Bureau of Statistics (ABS) economic datasets
and saves them as Excel files into data/raw/.
"""
...
# ABS "latest-release" URLs resolve to the most recent published file.
DATASETS = {
    "cpi": (
        "https://www.abs.gov.au/statistics/economy/price-indexes-and-inflation"
        "/consumer-price-index-australia/latest-release/640101.xlsx"
    ),
    "unemployment": (
        "https://www.abs.gov.au/statistics/labour/employment-and-unemployment"
        "/labour-force-australia/latest-release/6202001.xlsx"
    ),
    "wpi": (
        "https://www.abs.gov.au/statistics/economy/price-indexes-and-inflation"
        "/wage-price-index-australia/latest-release/634501.xlsx"
    ),
    "gdp": (
